import{_ as s,o as a,c as n,R as i}from"./chunks/framework.ymTWbDx7.js";const m=JSON.parse('{"title":"修改iframe内部元素的样式","description":"修改iframe内部元素的样式","frontmatter":{"title":"修改iframe内部元素的样式","head":[["meta",{"name":"description","content":"修改iframe内部元素的样式"}],["meta",{"name":"keywords","content":"iframe,样式修改"}]],"layout":"doc"},"headers":[],"relativePath":"frontend/iframe.md","filePath":"frontend/iframe.md","lastUpdated":1707141590000}'),e={name:"frontend/iframe.md"},t=i(`<h1 id="修改iframe内部元素的样式" tabindex="-1">修改iframe内部元素的样式 <a class="header-anchor" href="#修改iframe内部元素的样式" aria-label="Permalink to &quot;修改iframe内部元素的样式&quot;">​</a></h1><h2 id="htmliframeelement-contentdocument" tabindex="-1">HTMLIFrameElement.contentDocument <a class="header-anchor" href="#htmliframeelement-contentdocument" aria-label="Permalink to &quot;HTMLIFrameElement.contentDocument&quot;">​</a></h2><p>使用这个方法获取页面iframe中的dom对象，注意可能会有下面两种结果：</p><ul><li>如果iframe和它的父级在同一个域名下，那么这个方法返回document（是一个嵌套的浏览器上下文环境）</li><li>如果iframe和它的父级不在同一个域名下，那么这个方法返回null</li></ul><p>有了上面的这个原则，我们就知道在不跨域的情况下我们能够更容易的修改iframe内部元素的样式，跨域情况则无法获取到iframe内部的元素，只能通过其他方式来达到目的（下面会介绍），首先来看下不跨域是怎样做的。</p><h2 id="不跨域修改iframe中元素的样式" tabindex="-1">不跨域修改iframe中元素的样式 <a class="header-anchor" href="#不跨域修改iframe中元素的样式" aria-label="Permalink to &quot;不跨域修改iframe中元素的样式&quot;">​</a></h2><h3 id="方式1-直接获取到元素修改" tabindex="-1">方式1：直接获取到元素修改 <a class="header-anchor" href="#方式1-直接获取到元素修改" aria-label="Permalink to &quot;方式1：直接获取到元素修改&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">let</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> iframeDocument </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> document.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">getElementsByTagName</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;iframe&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)[</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">].contentDocument;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// This would turn the iframe blue.</span></span></code></pre></div><p>通过上面的操作，把iframe中body的背景色修改为“blue”</p><h3 id="方式2-在iframe的head中插入样式表" tabindex="-1">方式2：在iframe的head中插入样式表 <a class="header-anchor" href="#方式2-在iframe的head中插入样式表" aria-label="Permalink to &quot;方式2：在iframe的head中插入样式表&quot;">​</a></h3><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">// 页面上有一个id为i1的iframe，它嵌入的是同源的文件 child.html</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>当iframe加载完成后，我们向它内部传递了activateTheme(&quot;light&quot;);浅色主题的消息，下面看下它内部如何接收并做出响应：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// cross.html</span></span>
...
<span class="line"><span>    &lt;/script&gt;</span></span>
<span class="line"><span>&lt;/body&gt;</span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre></div><p>可以看出，我们在接收到父级传来的消息，根据消息的内容来修改了cross.html body的背景色。并且在这里我们可以做一下是否同源的安全校验。</p><blockquote><p>到这里我们可以得出一个结论：如果你嵌入的iframe页面和父级不是同一域下，而且当你可以在iframe页面中监听事件，这样你才能修改它内部的样式，否则无法修改。</p></blockquote>`,22),p=[t];function l(h,o,r,k,d,c){return a(),n("div",null,p)}const g=s(e,[["render",l]]);export{m as __pageData,g as default};
